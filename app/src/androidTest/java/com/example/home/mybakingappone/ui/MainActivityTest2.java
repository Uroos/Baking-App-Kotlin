...
public class MainActivityTest2 {
    ...
    public void mainActivityTest2() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tv_recipe_step), withText("Recipe Introduction"),
                        childAtPosition(
                                allOf(withId(R.id.rv_recipe_step),
                                        childAtPosition(
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.tv_recipe_step_description), withText("Recipe Introduction"),
                        childAtPosition(
                                allOf(withId(R.id.step_instruction_container),
                                        childAtPosition(
                                                withId(R.id.recipe_step_detail_linear_layout),
                                                1)),
                                0),
                        isDisplayed()));
