...
//
//    private lateinit var task: OkHttpHandler
...
//
//        task = OkHttpHandler()
//        task.setUpdateListener(context2 as OkHttpHandler.OnUpdateListener,mIdlingResource)
//
...
//            layoutManager = GridLayoutManager(context2, 4)
//
//        } else {
//            if (configuration.orientation == Configuration.ORIENTATION_PORTRAIT) {
//                layoutManager = GridLayoutManager(context2, 1)
//            } else if (configuration.orientation == Configuration.ORIENTATION_LANDSCAPE) {
//                layoutManager = GridLayoutManager(context2, 2)
//
//            }
//
//        }
